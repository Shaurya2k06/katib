...
- feat(release): automate Katib releases (@shaurya2k06)
- feat(docs): Add Changelog for v0.19.0 ([#2586](https://github.com/kubeflow/katib/pull/2586) by @andreyvelich)
- feat(release): Update Katib release script to publish SDK models ([#2584](https://github.com/kubeflow/katib/pull/2584) by @andreyvelich)
- feat(sdk): Support multiple pip index URLs. ([#2566](https://github.com/kubeflow/katib/pull/2566) by @wassimbensalem)
- feat: Add trial_timeout parameter to Katib tune API ([#2568](https://github.com/kubeflow/katib/pull/2568) by @wassimbensalem)
- feat(ci): Add Trivy Vulnerability Scan ([#2570](https://github.com/kubeflow/katib/pull/2570) by @andreyvelich)
- feat(docs): Guide to report security vulnerabilities ([#2556](https://github.com/kubeflow/katib/pull/2556) by @andreyvelich)
- feat: add `CITATION.cff` file ([#2547](https://github.com/kubeflow/katib/pull/2547) by @milinddethe15)
- feat: add naming regex check on validating webhook ([#1541](https://github.com/kubeflow/katib/pull/1541) by @anencore94)
- feat: Ignore pb files in update gofmt ([#1340](https://github.com/kubeflow/katib/pull/1340) by @andreyvelich)
- feat(experiment): Add a check before deletion ([#1223](https://github.com/kubeflow/katib/pull/1223) by @gaocegege)
- feat: Add 2020 roadmap ([#1121](https://github.com/kubeflow/katib/pull/1121) by @gaocegege)
- feat: Support disable GRPC probe ([#1020](https://github.com/kubeflow/katib/pull/1020) by @gaocegege)
- feat: Add adopters ([#1019](https://github.com/kubeflow/katib/pull/1019) by @gaocegege)
- feat: Do not inject sh -c when it exists ([#1010](https://github.com/kubeflow/katib/pull/1010) by @gaocegege)
- feat: Support resource in sidecar ([#991](https://github.com/kubeflow/katib/pull/991) by @gaocegege)
- feat: Add a flag to control the logic about sc ([#994](https://github.com/kubeflow/katib/pull/994) by @gaocegege)
- feat(experiment_status): Add trial name ([#986](https://github.com/kubeflow/katib/pull/986) by @gaocegege)
- feat(config): Add a new config for webhook ([#980](https://github.com/kubeflow/katib/pull/980) by @gaocegege)
- feat: Support running ([#894](https://github.com/kubeflow/katib/pull/894) by @gaocegege)
- feat: Add limit for suggestion pod ([#932](https://github.com/kubeflow/katib/pull/932) by @gaocegege)
- feat: Support custom database ([#910](https://github.com/kubeflow/katib/pull/910) by @gaocegege)
- feat: Patch to fix running condition ([#895](https://github.com/kubeflow/katib/pull/895) by @gaocegege)
- feat: Add quick start ([#878](https://github.com/kubeflow/katib/pull/878) by @gaocegege)
- feat: Add event when the reconcile is failed ([#879](https://github.com/kubeflow/katib/pull/879) by @gaocegege)
- feat: Add events in experiment ([#880](https://github.com/kubeflow/katib/pull/880) by @gaocegege)
- feat: Refactor to make it easy to extend new kinds ([#865](https://github.com/kubeflow/katib/pull/865) by @gaocegege)
- feat: Support random state in random search ([#873](https://github.com/kubeflow/katib/pull/873) by @gaocegege)
- feat: Support env in mysql ([#868](https://github.com/kubeflow/katib/pull/868) by @gaocegege)
- feat: Add liveness probe for DB ([#871](https://github.com/kubeflow/katib/pull/871) by @gaocegege)
- feat: Add doc about algorithm ([#867](https://github.com/kubeflow/katib/pull/867) by @gaocegege)
- feat: Add doc about how to add a new kind in trial ([#844](https://github.com/kubeflow/katib/pull/844) by @gaocegege)
- feat: Show experiment status in json ([#853](https://github.com/kubeflow/katib/pull/853) by @gaocegege)
- feat: Set default namespace and template for trial ([#850](https://github.com/kubeflow/katib/pull/850) by @gaocegege)
- feat: Add doc for implementing new algorithms ([#769](https://github.com/kubeflow/katib/pull/769) by @gaocegege)
- feat: Support namespace in NAS UI ([#839](https://github.com/kubeflow/katib/pull/839) by @gaocegege)
- feat: Show all experiments in monitor ([#835](https://github.com/kubeflow/katib/pull/835) by @gaocegege)
- feat: support namespace for trial template ([#827](https://github.com/kubeflow/katib/pull/827) by @gaocegege)
- feat: Use env var for namespace ([#829](https://github.com/kubeflow/katib/pull/829) by @gaocegege)
- feat: Support step when using grid in UI ([#821](https://github.com/kubeflow/katib/pull/821) by @gaocegege)
- feat: Remove useless APIs ([#818](https://github.com/kubeflow/katib/pull/818) by @gaocegege)
- feat: Add validation for grid ([#812](https://github.com/kubeflow/katib/pull/812) by @gaocegege)
- feat: Add tpe e2e test case ([#809](https://github.com/kubeflow/katib/pull/809) by @gaocegege)
- feat: Add HyperBand ([#787](https://github.com/kubeflow/katib/pull/787) by @gaocegege)
- feat: Add NAS RL based algorithm ([#793](https://github.com/kubeflow/katib/pull/793) by @gaocegege)
- feat: Rename algorithms ([#794](https://github.com/kubeflow/katib/pull/794) by @gaocegege)
- feat: Add events in suggestion ([#796](https://github.com/kubeflow/katib/pull/796) by @gaocegege)
- feat: Add grid with the help of chocolate ([#780](https://github.com/kubeflow/katib/pull/780) by @gaocegege)
- feat: Add bayesian ([#777](https://github.com/kubeflow/katib/pull/777) by @gaocegege)
- feat: Remove useless algorithms ([#782](https://github.com/kubeflow/katib/pull/782) by @gaocegege)
- feat: Add GRPC health check in suggestions ([#779](https://github.com/kubeflow/katib/pull/779) by @gaocegege)
- feat: Add more output in e2e test for debug purpose and fix test cases ([#775](https://github.com/kubeflow/katib/pull/775) by @gaocegege)
- feat(GRPC): Replace trial with assignment ([#767](https://github.com/kubeflow/katib/pull/767) by @gaocegege)
- feat: Enable python test ([#766](https://github.com/kubeflow/katib/pull/766) by @gaocegege)
- feat: Support HyperOpt ([#753](https://github.com/kubeflow/katib/pull/753) by @gaocegege)
- feat(GRPC): Update API for Suggestion ([#743](https://github.com/kubeflow/katib/pull/743) by @gaocegege)
- feat: Add suggestion controller ([#742](https://github.com/kubeflow/katib/pull/742) by @gaocegege)
- feat(apis): Add suggestion CRD API ([#740](https://github.com/kubeflow/katib/pull/740) by @gaocegege)
- feat(experiment): Delete dup trials ([#647](https://github.com/kubeflow/katib/pull/647) by @gaocegege)
- feat: Support bayesianoptimization in v1alpha2 ([#595](https://github.com/kubeflow/katib/pull/595) by @gaocegege)
- feat: Add UI in manifests v1alpha2 ([#591](https://github.com/kubeflow/katib/pull/591) by @gaocegege)
- feat: Support flags in UI ([#590](https://github.com/kubeflow/katib/pull/590) by @gaocegege)
- feat(trial): Add more failure test cases ([#570](https://github.com/kubeflow/katib/pull/570) by @gaocegege)
- feat(experiment): Add more test cases ([#563](https://github.com/kubeflow/katib/pull/563) by @gaocegege)
- feat(experiment-validator): Inject client ([#561](https://github.com/kubeflow/katib/pull/561) by @gaocegege)
- feat(experiment): Add test cases ([#556](https://github.com/kubeflow/katib/pull/556) by @gaocegege)
- feat(trial): Refactor trial controller and add basic test cases ([#528](https://github.com/kubeflow/katib/pull/528) by @gaocegege)
- feat(api): Add total number of trials ([#501](https://github.com/kubeflow/katib/pull/501) by @gaocegege)
- feat(CI): Run different flow according to version ([#516](https://github.com/kubeflow/katib/pull/516) by @gaocegege)

## Bug Fixes

- fix(metrics-collector): Use StrictValidation for RemoteImage call ([#2583](https://github.com/kubeflow/katib/pull/2583) by @andreyvelich)
- fix(controller): Fix RBAC to create TrainJobs ([#2581](https://github.com/kubeflow/katib/pull/2581) by @andreyvelich)
- fix(webhook): fix validation message in experiment webhook ([#2507](https://github.com/kubeflow/katib/pull/2507) by @Electronic-Waste)
- fix(api): resolve all api voilation exceptions in katib api ([#2482](https://github.com/kubeflow/katib/pull/2482) by @truc0)
- fix(trial): use propagated gomega to improve debuggability. ([#2432](https://github.com/kubeflow/katib/pull/2432) by @Electronic-Waste)
- fix(ui): update None Collector with Push Collector. ([#2418](https://github.com/kubeflow/katib/pull/2418) by @Electronic-Waste)
- fix: Resolve errors in e2e tests for cypress in Katib UI ([#2384](https://github.com/kubeflow/katib/pull/2384) by @tariq-hasan)
- fix: remove remaining MXNet dependency. ([#2456](https://github.com/kubeflow/katib/pull/2456) by @Electronic-Waste)
- fix: remove the dependency of `protocmp` in `google.golang.org/protobuf/testing/protocmp`. ([#2391](https://github.com/kubeflow/katib/pull/2391) by @Electronic-Waste)
- fix: clean up UTs for file metrics collector ([#2285](https://github.com/kubeflow/katib/pull/2285) by @Electronic-Waste)
- fix: only validate Kubernetes Job ([#2025](https://github.com/kubeflow/katib/pull/2025) by @zhixian82)
- fix: check if parameter references exist in experiment parameters ([#1726](https://github.com/kubeflow/katib/pull/1726) by @henrysecond1)
- fix: close mysql statement and rows resources when sql exec end ([#1720](https://github.com/kubeflow/katib/pull/1720) by @chenwenjun-github)
- fix(metrics-collector): allow user to nuke ephemeral-storage requests ([#1312](https://github.com/kubeflow/katib/pull/1312) by @khersey)
- fix: Ignore trials without metrics ([#1028](https://github.com/kubeflow/katib/pull/1028) by @gaocegege)
- fix: First check failed condition ([#1015](https://github.com/kubeflow/katib/pull/1015) by @gaocegege)
- fix: Avoid out-of-range exception ([#1012](https://github.com/kubeflow/katib/pull/1012) by @gaocegege)
- fix: Inherit labels and annotations from experiment ([#998](https://github.com/kubeflow/katib/pull/998) by @gaocegege)
- fix: Ignore the failure ([#996](https://github.com/kubeflow/katib/pull/996) by @gaocegege)
- fix: Add Suggestion into CI ([#907](https://github.com/kubeflow/katib/pull/907) by @gaocegege)
- fix: Use 64 instead of 32 since we are using float64 ([#883](https://github.com/kubeflow/katib/pull/883) by @gaocegege)
- fix: Use as instead of , to support python 3 in tfevent metrics collector ([#881](https://github.com/kubeflow/katib/pull/881) by @gaocegege)
- fix: Use binary in test ([#875](https://github.com/kubeflow/katib/pull/875) by @gaocegege)
- fix: Fix docs about metrics collection and sugg ([#858](https://github.com/kubeflow/katib/pull/858) by @gaocegege)
- fix: Reorder ([#847](https://github.com/kubeflow/katib/pull/847) by @gaocegege)
- fix: Use namespace to get trial list ([#846](https://github.com/kubeflow/katib/pull/846) by @gaocegege)
- fix: Update liveness probe to avoid problems ([#833](https://github.com/kubeflow/katib/pull/833) by @gaocegege)
- fix: Support multiple namespaces ([#826](https://github.com/kubeflow/katib/pull/826) by @gaocegege)
- fix: Build e2e-runner ([#822](https://github.com/kubeflow/katib/pull/822) by @gaocegege)
- fix: Fix the type ([#813](https://github.com/kubeflow/katib/pull/813) by @gaocegege)
- fix: Remove copy ([#802](https://github.com/kubeflow/katib/pull/802) by @gaocegege)
- fix: Use commitid ([#799](https://github.com/kubeflow/katib/pull/799) by @gaocegege)
- fix: Add build for sidecar ([#730](https://github.com/kubeflow/katib/pull/730) by @gaocegege)
- fix: Do not use webhook in UT ([#657](https://github.com/kubeflow/katib/pull/657) by @gaocegege)
- fix: Check if the deletion time is nil or zero ([#567](https://github.com/kubeflow/katib/pull/567) by @gaocegege)
- fix: Fix the conflicts ([#545](https://github.com/kubeflow/katib/pull/545) by @gaocegege)
- fix(status): Define status handler ([#518](https://github.com/kubeflow/katib/pull/518) by @gaocegege)
- fix: Add test cases for validator and manifest generator ([#508](https://github.com/kubeflow/katib/pull/508) by @gaocegege)
- fix: Avoid side effect ([#532](https://github.com/kubeflow/katib/pull/532) by @gaocegege)
- fix(readme): Merge image directory ([#455](https://github.com/kubeflow/katib/pull/455) by @gaocegege)

## Misc

- chore: add welcome workflow for new contributors ([#2595](https://github.com/kubeflow/katib/pull/2595) by @aniketpati1121)
- chore(models): Move models into kubeflow_katib_api package ([#2579](https://github.com/kubeflow/katib/pull/2579) by @kramaranya)
- chore: Bump go-containerregistry to v0.20.6 ([#2575](https://github.com/kubeflow/katib/pull/2575) by @andreyvelich)
- chore(deps): bump golang.org/x/oauth2 from 0.21.0 to 0.27.0 ([#2558](https://github.com/kubeflow/katib/pull/2558) by @dependabot[bot])
- chore: Upgrade Go version to 1.23 ([#2526](https://github.com/kubeflow/katib/pull/2526) by @tenzen-y)
- chore(docs): Add OpenSSF Badge ([#2555](https://github.com/kubeflow/katib/pull/2555) by @andreyvelich)
- chore(test): Removed the no longer needed trigger-rerun-test.yaml ([#2540](https://github.com/kubeflow/katib/pull/2540) by @hbelmiro)
- chore(docs): Add Changelog Katib v0.18.0 ([#2537](https://github.com/kubeflow/katib/pull/2537) by @andreyvelich)
- chore: supporting the listen-address parameter on db-manager ([#2465](https://github.com/kubeflow/katib/pull/2465) by @caiofralmeida)
- chore: add unit testcases for files in Text format. ([#2274](https://github.com/kubeflow/katib/pull/2274) by @Electronic-Waste)
- chore: Upgrade Go libraries to resolve some security issues in the katib-controller ([#1888](https://github.com/kubeflow/katib/pull/1888) by @tenzen-y)
- chore: Update OWNERS ([#1235](https://github.com/kubeflow/katib/pull/1235) by @gaocegege)
- chore(deps): Bump tensorflow in /cmd/suggestion/nasrl/v1alpha3 ([#1035](https://github.com/kubeflow/katib/pull/1035) by @dependabot[bot])
- chore(deps): Bump psutil ([#1085](https://github.com/kubeflow/katib/pull/1085) by @dependabot[bot])
- chore(deps): Bump tensorflow-gpu ([#1034](https://github.com/kubeflow/katib/pull/1034) by @dependabot[bot])
- chore(deps): Bump tensorflow ([#1036](https://github.com/kubeflow/katib/pull/1036) by @dependabot[bot])
- chore: Update docs ([#1024](https://github.com/kubeflow/katib/pull/1024) by @gaocegege)
- chore(deps): Bump tensorflow ([#1005](https://github.com/kubeflow/katib/pull/1005) by @dependabot[bot])
- chore(deps): Bump tensorflow-gpu ([#978](https://github.com/kubeflow/katib/pull/978) by @dependabot[bot])
- chore: Add dockerignore, enhance liveness for manager ([#851](https://github.com/kubeflow/katib/pull/851) by @gaocegege)
- chore: Add code coverage test ([#560](https://github.com/kubeflow/katib/pull/560) by @gaocegege)
- chore: Refactor nasenvelopenet ([#492](https://github.com/kubeflow/katib/pull/492) by @gaocegege)
- chore: Remove dep ensure in CI ([#525](https://github.com/kubeflow/katib/pull/525) by @gaocegege)
- chore: Skip test when code is not changed ([#467](https://github.com/kubeflow/katib/pull/467) by @gaocegege)

## Documentation

- docs: remove katib workflow ([#2443](https://github.com/kubeflow/katib/pull/2443) by @gonmmarques)
- docs: update suggestion.md ([#2387](https://github.com/kubeflow/katib/pull/2387) by @eltociear)
- docs: Add my presentations that include Katib ([#1753](https://github.com/kubeflow/katib/pull/1753) by @terrytangyuan)
- docs: Argo -> Argo Workflows ([#1741](https://github.com/kubeflow/katib/pull/1741) by @terrytangyuan)
- docs: Fix wrong command ([#108](https://github.com/kubeflow/katib/pull/108) by @mrkm4ntr)
- docs: Generate CLI documentation ([#105](https://github.com/kubeflow/katib/pull/105) by @gaocegege)
- docs: Update katib ([#36](https://github.com/kubeflow/katib/pull/36) by @gaocegege)
